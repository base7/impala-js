...
describe("Impala", () => {
  ...
  describe("when called with an apiKey", () => {
    let instance;
    beforeEach(() => {
      instance = new Impala({ apiKey: "API_KEY" });
    });
    afterEach(() => {
      instance = null;
    });
  ...
  describe("when called with an apiKey and hotelId", () => {
    let instance;
    beforeEach(() => {
      instance = new Impala({ apiKey: "API_KEY", hotelId: "HOTEL" });
    });
    afterEach(() => {
      instance = null;
    });
    ...
    it("...which shouldn't have a getHotel method", () => {
      expect(instance).to.not.have.property("getHotel");
    });
  });
});
